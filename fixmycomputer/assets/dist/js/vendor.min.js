...
**/($ = void 0 === $ ? jQuery : $)(document).ready(function() {
...
var waitForFinalEvent = function() {
    ...
    return function(e, t, n) {
        i[n = n || "Don't call this twice without a uniqueId"] && clearTimeout(i[n]), i[n] = setTimeout(e, t);
    };
}();
"use strict";
...
!function(i) {
    ...
    o = 0, (r = function(i, e) {
        ...
        o.slideOffset += o.slideWidth * Math.floor(o.options.slidesToShow / 2)), e = !1 === o.options.vertical ? i * o.slideWidth * -1 + o.slideOffset : i * e * -1 + s, 
        !0 === o.options.variableWidth && (s = o.slideCount <= o.options.slidesToShow || !1 === o.options.infinite ? o.$slideTrack.children(".slick-slide").eq(i) : o.$slideTrack.children(".slick-slide").eq(i + o.options.slidesToShow), 
        e = !0 === o.options.rtl ? s[0] ? -1 * (o.$slideTrack.width() - s[0].offsetLeft - s.width()) : 0 : s[0] ? -1 * s[0].offsetLeft : 0, 
        !0 === o.options.centerMode && (s = o.slideCount <= o.options.slidesToShow || !1 === o.options.infinite ? o.$slideTrack.children(".slick-slide").eq(i) : o.$slideTrack.children(".slick-slide").eq(i + o.options.slidesToShow + 1), 
        e = !0 === o.options.rtl ? s[0] ? -1 * (o.$slideTrack.width() - s[0].offsetLeft - s.width()) : 0 : s[0] ? -1 * s[0].offsetLeft : 0, 
        ...
        s.$slides.eq(i).addClass("slick-center")) : 0 <= i && i <= s.slideCount - s.options.slidesToShow ? s.$slides.slice(i, i + s.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false") : n.length <= s.options.slidesToShow ? n.addClass("slick-active").attr("aria-hidden", "false") : (o = s.slideCount % s.options.slidesToShow, 
        e = !0 === s.options.infinite ? s.options.slidesToShow + i : i, (s.options.slidesToShow == s.options.slidesToScroll && s.slideCount - i < s.options.slidesToShow ? n.slice(e - (s.options.slidesToShow - o), e + o) : n.slice(e, e + s.options.slidesToShow)).addClass("slick-active").attr("aria-hidden", "false")), 
        ...
        var o, s, n, r, l = this;
        if (e = e || !1, !(!0 === l.animating && !0 === l.options.waitForAnimate || !0 === l.options.fade && l.currentSlide === i)) if (!1 === e && l.asNavFor(i), 
        o = i, r = l.getLeft(o), e = l.getLeft(l.currentSlide), l.currentLeft = null === l.swipeLeft ? e : l.swipeLeft, 
        !1 === l.options.infinite && !1 === l.options.centerMode && (i < 0 || i > l.getDotCount() * l.options.slidesToScroll)) !1 === l.options.fade && (o = l.currentSlide, 
        !0 !== t ? l.animateSlide(e, function() {
            l.postSlide(o);
        }) : l.postSlide(o)); else if (!1 === l.options.infinite && !0 === l.options.centerMode && (i < 0 || i > l.slideCount - l.options.slidesToScroll)) !1 === l.options.fade && (o = l.currentSlide, 
        !0 !== t ? l.animateSlide(e, function() {
            l.postSlide(o);
        }) : l.postSlide(o)); else {
            ...
            l.currentSlide = s, l.setSlideClasses(l.currentSlide), l.options.asNavFor && (n = (n = l.getNavTarget()).slick("getSlick")).slideCount <= n.options.slidesToShow && n.setSlideClasses(l.currentSlide), 
            l.updateDots(), l.updateArrows(), !0 === l.options.fade) return !0 !== t ? (l.fadeSlideOut(e), 
        ...
        var i = this, e = i.touchObject.startX - i.touchObject.curX, t = i.touchObject.startY - i.touchObject.curY, e = Math.atan2(t, e);
        ...
        !o.options.verticalSwiping && !o.swiping && 4 < t ? !(o.scrolling = !0) : (!0 === o.options.verticalSwiping && (o.touchObject.swipeLength = t), 
        s = o.swipeDirection(), void 0 !== i.originalEvent && 4 < o.touchObject.swipeLength && (o.swiping = !0, 
        i.preventDefault()), t = (!1 === o.options.rtl ? 1 : -1) * (o.touchObject.curX > o.touchObject.startX ? 1 : -1), 
...
!function(n) {
    ...
    o.m = n, o.c = s, o.d = function(t, e, n) {
    ...
    var s = (m.prototype.add = function(t, e) {
        this.matchFns.push(t), this.unmatchFns.push(e), (this.toggler.matches ? t : e)();
    }, m), a = ("ontouchstart" in window || navigator.msMaxTouchPoints, -1 < navigator.userAgent.indexOf("MSIE") || -1 < navigator.appVersion.indexOf("Trident/")), c = "mm-spn", d = (Object.defineProperty(p.prototype, "prefix", {
        get: function() {
            return c;
        },
        enumerable: !1,
        configurable: !0
    }), p.prototype.openPanel = function(t) {
        var e = t.parentElement;
        if (this.slidingSubmenus) {
            var n = t.dataset.mmSpnTitle;
            e === this.node ? this.node.classList.add(c + "--main") : (this.node.classList.remove(c + "--main"), 
            n || i(e.children).forEach(function(t) {
                t.matches("a, span") && (n = t.textContent);
            })), n = n || this.title, this.node.dataset.mmSpnTitle = n, r(".mm-spn--open", this.node).forEach(function(t) {
                t.classList.remove(c + "--open"), t.classList.remove(c + "--parent");
            }), t.classList.add(c + "--open"), t.classList.remove(c + "--parent");
            for (var s = t.parentElement.closest("ul"); s; ) s.classList.add(c + "--open"), 
            s.classList.add(c + "--parent"), s = s.parentElement.closest("ul");
        } else {
            e = t.matches(".mm-spn--open");
            r(".mm-spn--open", this.node).forEach(function(t) {
                t.classList.remove(c + "--open");
            }), t.classList[e ? "remove" : "add"](c + "--open");
            for (var o = t.parentElement.closest("ul"); o; ) o.classList.add(c + "--open"), 
            o = o.parentElement.closest("ul");
        }
    }, p.prototype._setSelectedl = function() {
        var t = r("." + this.selectedClass, this.node), e = t[t.length - 1], t = null, t = (t = e ? e.closest("ul") : t) || this.node.querySelector("ul");
        this.openPanel(t);
    }, p.prototype._initAnchors = function() {
        var s = this;
        this.node.addEventListener("click", function(t) {
            var e, n = t.target;
            !n.matches("a") && (!(e = (e = n).closest("span") ? e.parentElement : !!e.closest("li") && e) || (i(e.children).forEach(function(t) {
                t.matches("ul") && s.openPanel(t);
            }), 0)) && !function() {
                var t = r(".mm-spn--open", n), t = t[t.length - 1];
                if (t) {
                    t = t.parentElement.closest("ul");
                    if (t) return s.openPanel(t), !0;
                }
                return !1;
            }() || t.stopImmediatePropagation();
        });
    }, p), o = (Object.defineProperty(u.prototype, "prefix", {
        get: function() {
            return "mm-ocd";
        },
        enumerable: !1,
    ...
    }, u), n = (l.prototype.navigation = function(t) {
        var e, n, s, o = this;
        return this.navigator || (e = (t = t || {}).title, n = t.selectedClass, s = t.slidingSubmenus, 
        t = t.theme, this.navigator = new d(this.menu, void 0 === e ? "Menu" : e, void 0 === n ? "Selected" : n, void 0 === s || s, void 0 === t ? "light" : t), 
        this.toggler.add(function() {
            return o.menu.classList.add(o.navigator.prefix);
        }, function() {
            return o.menu.classList.remove(o.navigator.prefix);
        })), this.navigator;
    }, l.prototype.offcanvas = function(t) {
        var e, n = this;
        return this.drawer || (t = (t = t || {}).position, this.drawer = new o(null, void 0 === t ? "left" : t), 
        e = document.createComment("original menu location"), this.menu.after(e), this.toggler.add(function() {
    ...
    function l(t, e) {
        void 0 === e && (e = "all"), this.menu = t, this.toggler = new s(e);
    }
    function u(t, e) {
        var n = this;
        void 0 === t && (t = null), this.wrapper = document.createElement("div"), this.wrapper.classList.add("mm-ocd"), 
        this.wrapper.classList.add("mm-ocd--" + e), this.content = document.createElement("div"), 
        this.content.classList.add("mm-ocd__content"), this.wrapper.append(this.content), 
        this.backdrop = document.createElement("div"), this.backdrop.classList.add("mm-ocd__backdrop"), 
        this.wrapper.append(this.backdrop), document.body.append(this.wrapper), t && this.content.append(t);
        t = function(t) {
            n.close(), t.stopImmediatePropagation();
        };
        this.backdrop.addEventListener("touchstart", t, {
            passive: !0
    ...
    function p(t, e, n, s, o) {
        this.node = t, this.title = e, this.slidingSubmenus = s, this.selectedClass = n, 
        this.node.classList.add(c), a && (this.slidingSubmenus = !1), this.node.classList.add(c + "--" + o), 
        this.node.classList.add(c + "--" + (this.slidingSubmenus ? "navbar" : "vertical")), 
    ...
    function m(t) {
        ...
        }, this.toggler = window.matchMedia(t), this.toggler.addListener(this.listener), 
...
class PhoneField {
    constructor(e) {
        var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : "+7(___)___-____", s = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : "_";
        this.handler = e, this.mask = t, this.placeholder = s, this.setLength(), this.setValue(), 
        this.start = this.placeHolderPosition() - 1, this.handler.addEventListener("focusin", () => {
            this.focused();
    ...
    focused() {
        var e = this.placeHolderPosition();
        this.handler.selectionStart = e, this.handler.selectionEnd = e;
    }
    input(e) {
        this.isDirectionKey(e.key) || e.preventDefault(), this.isNum(e.key) ? this.changeChar(e.key) : this.isDeletionKey(e.key) && ("Backspace" === e.key ? (e = this.start, 
        this.changeChar(this.placeholder, -1, e)) : this.changeChar(this.placeholder));
    }
    setLength() {
    ...
    isNum(e) {
        return !isNaN(e) && parseInt(+e) == e && !isNaN(parseInt(e, 10));
    }
    isDeletionKey(e) {
        return "Delete" === e || "Backspace" === e;
    }
    isDirectionKey(e) {
        return "ArrowUp" === e || "ArrowDown" === e || "ArrowRight" === e || "ArrowLeft" === e || "Tab" === e;
    }
    isPlaceholder(e) {
    ...
    changeChar(e) {
        var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 1, s = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : this.mask.length;
        let i = this.handler.value, h;
        h = 0 < t ? this.handler.selectionStart : this.handler.selectionStart - 1;
        var n;
        if (h === s) return !1;
        if (!this.isNum(i[h]) && !this.isPlaceholder(i[h])) do {
            if (h += t, h === s) return !1;
        } while (!this.isNum(i[h]) && !this.isPlaceholder(i[h]));
        n = this.replaceAt(i, h, e), this.handler.value = n, 0 < t && (h += t), this.handler.selectionStart = h, 
        this.handler.selectionEnd = h;
    }
    replaceAt(e, t, s) {
        return e.substring(0, t) + s + e.substring(++t);
    }
}

document.addEventListener("DOMContentLoaded", function() {
    let t = document.getElementsByClassName("masked-phone"), s = [];
    for (let e = 0; e < t.length; e++) s.push(new PhoneField(t[e], t[e].dataset.phonemask, t[e].dataset.placeholder));
});
